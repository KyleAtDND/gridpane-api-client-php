...
class SatisfactionRatingsTest extends BasicTest
{
     ...
     *
     * @expectedException GridPane\API\Exceptions\MissingParametersException
     *
     * @expectedExceptionMessage Missing parameters: 'ticket_id' must be supplied for GridPane\API\Resources\Core\SatisfactionRatings::create
     */
