...
class ResourceTest extends BasicTest
{
     ...
     *
     * @expectedExceptionMessage GridPane may be experiencing internal issues or undergoing scheduled maintenance.
     */
    ...
    public function testUserAgent()
    {
        ...
        $this->assertRegExp('/GridPaneAPI PHP/', $request->getHeaderLine('User-Agent'));
    }
